...
export default function LandingPage() {
  ...
  const heroImgStyle = isMobile
    ? { width: '100%', maxWidth: 360, display: 'block', margin: '20px auto 0' }
    : { zoom: 0.5, display: 'block', position: 'relative', right: -140 }
  ...
  return (
    <div style={styles.page}>
      ...
      <section style={{
        ...
        paddingTop: isMobile ? 100 : 72,
        paddingBottom: isMobile ? 60 : 0,
      }}>
        <div style={{ ...styles.container, width: '100%', padding: isMobile ? '0 16px' : 0 }}>
          <div style={{
            ...styles.heroInner,
            ...
            <div style={{
              ...
              <p style={{
                ...
                让生成图海报、奖章包装和营销物料设计{isMobile ? '' : <br />}
                像点外卖一样简单高效
              </p>
      ...
      <section style={{
        ...styles.section,
        padding: isMobile ? '40px 16px' : '80px 0',
      }}>
        ...
        <div style={styles.avatarsRow}>
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div key={i} style={{
              ...
              marginLeft: i === 1 ? 0 : (isMobile ? -8 : -12),
            }}>
              <img
      ...
      <section style={{
        ...styles.ctaSection,
        padding: isMobile ? '40px 16px 60px' : '60px 0 80px',
      }}>
        <p style={{
          ...styles.ctaDesc,
          fontSize: isMobile ? 18 : 26,
        }}>
          礼企汇升级AI.Agent生态核心礼业设计生产力底座，重构礼业AI.设计出图{isMobile ? '' : <br />}
