        ...
        {user && !['/template-set', '/model-use'].some(p => location.pathname.startsWith(p)) && (
          <nav className="app-sidebar">
            <div className="sidebar-nav">
              ...
              <button className={`sidebar-tab${location.pathname === '/workbench' || location.pathname.startsWith('/my-gifts') || location.pathname.startsWith('/gift-editor') || location.pathname === '/image-list' ? ' active' : ''}`} onClick={() => { setSubmenuOpen(o => !o); navigate('/workbench') }}>
