  ...
  return (
    <div className="app">
      ...
      <div className="app-body">
        {user && location.pathname !== '/digital-album' && !['/workbench', '/my-gifts', '/gift-editor', '/ai-poster', '/template-set', '/model-use', '/image-list', '/prompt-set', '/resource-manage'].some(p => location.pathname.startsWith(p)) && <WorkbenchSidebar />}
        <main className="app-main" style={location.pathname === '/digital-album' || ['/workbench', '/my-gifts', '/gift-editor', '/ai-poster', '/template-set', '/model-use', '/image-list', '/prompt-set', '/resource-manage'].some(p => location.pathname.startsWith(p)) ? { padding: 0 } : undefined}>
        <Routes>
          ...
          <Route path="/resource-manage" element={<ErrorBoundary>{user ? (user.isAdmin ? <ResourceManage /> : <Navigate to="/workbench" replace />) : <Navigate to="/" />}</ErrorBoundary>} />
