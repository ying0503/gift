  ...
  return (
    <div className="app">
      ...
      <div className="app-body">
        {user && !['/workbench', '/my-gifts', '/gift-editor'].some(p => location.pathname.startsWith(p)) && <WorkbenchSidebar />}
        <main className="app-main" style={['/workbench', '/my-gifts', '/gift-editor'].some(p => location.pathname.startsWith(p)) ? { padding: 0 } : undefined}>
        <Routes>
